...
public class HIUtil {
	...
	// private static final String CARDNOARRAY[] = { "0", "00", "000", "0000",
	// "00000" };
	 ...
	 * @return
	 */
	public static List<UnAllotedSeat> creatRandomSeat(int compID, int tableType, int sysType,
			List<CardTable> cardTableList) {
		Random r = new Random();
	...
	public static String getMemCardNO(int id) {
		...
		return StringUtils.leftPad(memIDStr, CARDNOLENGTH, "0");
	...
	public static void sendResponse(String str, String contentType) {
		...
		response.setHeader("Cache-Control", "no-store, no-cache, must-revalidate"); // HTTP
																					// 1.1
	...
	public static void main(String[] args) {
		...
		// String imei = jsonBinder.getValue(JsonBinder.JSONObject, str,
		// "IMEI");
