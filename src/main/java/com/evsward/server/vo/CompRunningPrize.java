...
public class CompRunningPrize implements Serializable {
	...
	public String toString() {
		return "CompRunningPrize [compID=" + compID + ", memID="
				+ memID + ", percent=" + percent
				+ ", ranking=" + ranking + ", amountInt=" + amountInt
