...
public class ScreenCompTimeInfo implements Serializable {
	...
	public String getCompStateDesc() {
		switch(compState){
			case CompetitionInfo.COMPSTATE.STATE_NOREG:
				compStateDesc = CompetitionInfo.COMPSTATE.STATE_NOREGSHOW;
				break;
			case CompetitionInfo.COMPSTATE.STATE_REGING_NOBEGIN:
				compStateDesc = CompetitionInfo.COMPSTATE.STATE_REGING_NOBEGINSHOW;
				break;
			case CompetitionInfo.COMPSTATE.STATE_REGING_BEGINED:
				compStateDesc = CompetitionInfo.COMPSTATE.STATE_REGING_BEGINEDSHOW;
				break;
			case CompetitionInfo.COMPSTATE.STATE_REGEND_NOBEGIN:
				compStateDesc = CompetitionInfo.COMPSTATE.STATE_REGEND_NOBEGINSHOW;
				break;
			case CompetitionInfo.COMPSTATE.STATE_RUNNING:
				compStateDesc = CompetitionInfo.COMPSTATE.STATE_RUNNINGSHOW;
				break;
			default:
				compStateDesc = CompetitionInfo.COMPSTATE.STATE_ENDSHOW;
		}
