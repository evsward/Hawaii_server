...
public class CompListInfo implements Serializable {
	...
	public String getCompStateShow() {
		...
		case CompetitionInfo.COMPSTATE.STATE_REGEND_NOBEGIN:
			...
			break;
		case CompetitionInfo.COMPSTATE.COUNTDOWN_STATE_WAIT:
			this.compStateShow = CompetitionInfo.COMPSTATE.COUNTDOWN_STATE_WAITSHOW;
			break;
	...
	public CompListInfo(int compID, String compName, String time, int compState, int regFee, int serviceFee,
			int beginChip, int curRank, int curType, int reEntry, int amountUnit) {
		super();
		this.compID = compID;
		this.compName = compName;
		this.time = time;
