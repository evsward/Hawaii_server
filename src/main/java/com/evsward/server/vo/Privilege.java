...
public class Privilege implements Serializable {
	...
	public Privilege(Integer privID, String privName, String privPath,
			Integer privState, Integer privParentID, String privNameShow,
			String privDesc, String privUUID, Integer privDepth, Integer sysType,
	...
	public String toString() {
		return "Privilege [privID=" + privID + ", privName=" + privName
				+ ", privPath=" + privPath + ", privState=" + privState
				+ ", privParentID=" + privParentID + ", privNameShow="
				+ privNameShow + ", privDesc=" + privDesc + ", privUUID="
				+ privUUID + ", privDepth=" + privDepth + ", sysType="
				+ sysType + ", createTime=" + createTime + ", updateTime="
