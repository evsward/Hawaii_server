...
public class CompRunningRound implements Serializable {
	...
	public CompRunningRound(int roundTempID, int compID, int curBigBlind, int curSmallBlind,
			int curRank, int curBeforeChip, int curType, int stepLen,
			long curStartTime, long reStartTime, int sysType) {
		super();
		this.roundTempID = roundTempID;
		this.compID = compID;
		this.curBigBlind = curBigBlind;
	...
	public String toString() {
		return "CompRunningRound [compID=" + compID + ", roundTempID="
				+ roundTempID + ", curBigBlind=" + curBigBlind
				+ ", curSmallBlind=" + curSmallBlind + ", curRank=" + curRank
				+ ", curBeforeChip=" + curBeforeChip + ", curType=" + curType
				+ ", stepLen=" + stepLen + ", curStartTime=" + curStartTime
				+ ", reStartTime=" + reStartTime + ", sysType=" + sysType + "]";
	}
}
