...
public class Round implements Serializable {
	...
	public Round(int blindID, int roundTempID, int roundState, int bigBlind,
			int smallBlind, int stepLen, int roundType, int roundrank,
			int beforeChip) {
		super();
		this.blindID = blindID;
		this.roundTempID = roundTempID;
	...
	public String toString() {
		return "Round [blindID=" + blindID + ", roundTempID=" + roundTempID
				+ ", roundState=" + roundState + ", bigBlind=" + bigBlind
				+ ", smallBlind=" + smallBlind + ", stepLen=" + stepLen
				+ ", roundType=" + roundType + ", roundrank=" + roundrank
