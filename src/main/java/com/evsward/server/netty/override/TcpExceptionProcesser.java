 ...
 * 
 */
public class TcpExceptionProcesser extends
		GenericExceptionProcesser<TcpOriginalRequestMessage, TcpOriginalResponseMessage, MessageLite, MessageLite.Builder> {
	...
	@Override
	public MessageLite.Builder alertExceptionProcess(ChannelHandlerContext ctx, ExceptionEvent event,
			ServerContext serverContext, AlertException exception) throws IOException {
	...
	@Override
	public MessageLite.Builder validateExceptionProcess(ChannelHandlerContext ctx, ExceptionEvent event,
			ServerContext serverContext, ValidateException exception) throws IOException {
